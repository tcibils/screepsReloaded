...
var scout = {
    run: function(creep) {
		...
		let closestMyRoomDistanceToCheckSources = 6;		// We will not store information about the room sources if further from my closest room than this
		let closestMyRoomDistanceToCheckPlayers = 6;		// We will not store information about the room player/controller if further from my closest room than this
		let closestMyRoomDistanceToCheckPower = 8;			// We will not store information about the room power if further from my closest room than this
		...
		// If we reached the target room imposed by "god" - player manipulating the creep - or if the target room is undefined (creep.memory.targetRoom is defined by the player only)
